...
const featuredProjects = fetch(`https://${url}/api/featured-project`, {
    method: "GET",
})
    .then((response) => {
        if (!response.ok) {
        ...
        <div className={styles[("section", "third-section")]}>
            <div className={styles["my-work"]}>
                ...
                <LeftFeaturedProject
                    ...
                    githubLink={
                        characterObject["projects"][0].github_link.indexOf(
                            "https://"
                        ) == 0
                    ...
                    projectLink={
                        characterObject["projects"][0].project_link.indexOf(
                            "https://"
                        ) == 0
                ...
                <RightFeaturedProject
                    ...
                    githubLink={
                        characterObject["projects"][1].github_link.indexOf(
                            "https://"
                        ) == 0
                    ...
                    projectLink={
                        characterObject["projects"][1].project_link.indexOf(
                            "https://"
                        ) == 0
