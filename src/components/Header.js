...
import useScrollDirection from "../../public/hooks/useScrollDirection";
import useScrollLength from "../../public/hooks/useScrollLength";
...
function Header() {
    ...
    return(
        <header className={styles["nav-header"]} style={!scrolledToTop 
            ? (
