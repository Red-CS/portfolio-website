import styles from "../../styles/component/Fourth.module.css";
...
const FourthSection = () => (
    <div className={styles["section", "fourth-section"]}>
        <div className={styles["future-ventures"]}>
            {/* Future Ventures */}
            <h2 className={styles["section-header"]} id={styles["fourth-section-header"]}>Future Ventures</h2>
            <h3 className={styles["section-underline"]}>Areas in tech I plan to pursure</h3>
            &lt;&gt;
            <br />
            <br />
