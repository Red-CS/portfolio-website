...
function Menu() {
    ...
    return (
        <div className={`${styles.menu} ${styles["fade-enter-done"]}`} ref={wrapperRef}>
            <Helmet>
                <body className={menuOpen ? "blur" : ""} />
            </Helmet>
            <div className={styles["ham-button"]} onClick={toggleMenu} ref={buttonRef}>
            ...
            <style jsx>
                {`
                    .${styles["ham-box-inner"]} {
                        ...
                        background-color: ${menuOpen ? "var(--color-white)" : "var(--color-black)"};
                    }
